...
int main() {
    ...
    Bank my_bank5(my_bank1);
    Bank my_bank6(my_bank2);
    std::cout<<"Stream overload to mybank5 should be same with my bank 1"<<std::endl;
    std::cout<<my_bank5;
    std::cout<<"Stream overload to mybank6 should be same with my bank 2"<<std::endl;
    std::cout<<my_bank6;
    ...
    //sum and equal bank -> try with null
    std::cout<<"Sum and equal overload with empty Bank rhs"<<std::endl;
    my_bank1+= bnk;
    std::cout<<"Now my bank 1 is, shouldn't be changed"<<std::endl;
    std::cout<<my_bank1;
    std::cout<<my_bank1[3];


    std::cout<<"Sum and equal overload with empty Bank this"<<std::endl;
    bnk+=my_bank1;
    std::cout<<"Now my bnk is"<<std::endl;
    std::cout<<bnk;
    std::cout<<bnk[3];
    ...
    std::cout<<"Sum and equal overload with empty Account"<<std::endl;
    Account acc;
    my_bank2+= acc;
    std::cout<<"Bank 2 shouldn't be changed"<<std::endl;
    std::cout<<my_bank2;
    std::cout<<my_bank2[5];
    ...
    //sum and equal account -> try with null
    //indexing
