...
int main() {
    ...
    Account emptyAcc = Account();
    std::cout<<"Printing Empty "<<std::endl;
    std::cout<<emptyAcc<<std::endl;
    ...
    my_sec = my_first;
    std::cout<<"My Sec"<<std::endl;
    std::cout<<my_sec<<std::endl;


    if(my_first == my_sec){
        std::cout<<"My Sec is equal to my first"<<std::endl;
    }

    if(my_first == 1){
        std::cout<<"My first id is 1"<<std::endl;
    }

    // sum and equal -> test with both side equal to null
    std::cout<<"Sum and equal overload rhs null"<<std::endl;
    Account myNull;
    my_first+=myNull;
    std::cout<<"My First"<<std::endl;
    std::cout<<my_first<<std::endl;
    std::cout<<"Sum and equal overload this null"<<std::endl;
    Account myNull2;
    myNull2 += my_first;
    std::cout<<"My Null2"<<std::endl;
    std::cout<<my_first<<std::endl;
