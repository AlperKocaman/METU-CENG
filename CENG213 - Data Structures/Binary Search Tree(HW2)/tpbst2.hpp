...
private: // you may add your own utility member functions here.
    ...
    void remove_helper2( const std::string &secondaryKey, SecondaryNode * &sNode ) ;
    void remove_helper3( SecondaryNode * &sNode , SecondaryNode * &sNode2 ) ;
...
void TwoPhaseBST<T>::remove_helper1( const std::string &primaryKey, const std::string &secondaryKey, PrimaryNode * &pNode ) {
    ...
    if( pNode == NULL || pNode->key == "") {        
        ...
        remove_helper2( secondaryKey, pNode->rootSecondaryNode ) ;
             
    }
}

template <class T>
void TwoPhaseBST<T>::remove_helper2( const std::string &secondaryKey, SecondaryNode * &sNode ) {
    ...
    if( sNode == NULL || sNode->key == "" ) {
        ...
        remove_helper2( secondaryKey, sNode->left) ;
    }

    else if( sNode->key < secondaryKey ) {

        remove_helper2( secondaryKey, sNode->right) ;
    }
        ...
        else remove_helper3( sNode , sNode->right ) ; 
        
    }     
}

template <class T>
void TwoPhaseBST<T>::remove_helper3( SecondaryNode * &sNode , SecondaryNode * &sNode2 ) {
    ...
    sNode->data  = sNode2->data  ;

    sNode->key   = sNode2->key   ;
