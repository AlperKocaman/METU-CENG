...
/* Throughout this file refresh7Segment() function has been called
 * in some places for refreshing the displays more frequently and 
 * avoiding flickering in displays
 */
