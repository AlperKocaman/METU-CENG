...
DeclareTask(GAME_TASK);
DeclareTask(RCV_TASK);
DeclareTask(LCD);
...
rom_desc_tsk rom_desc_task0 = {
	GAME_TASK_PRIO,                       /* prioinit from 0 to 15       */
	stack0,                           /* stack address (16 bits)     */
	GAME_TASK,                            /* start address (16 bits)     */
	READY,                            /* state at init phase         */
	GAME_TASK_ID,                         /* id_tsk from 0 to 15         */
...
rom_desc_tsk rom_desc_task1 = {
	RCV_TASK_PRIO,                       /* prioinit from 0 to 15       */
	stack1,                           /* stack address (16 bits)     */
	RCV_TASK,                            /* start address (16 bits)     */
	READY,                            /* state at init phase         */
	RCV_TASK_ID,                         /* id_tsk from 0 to 15         */
