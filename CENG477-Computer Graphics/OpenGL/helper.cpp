...
void initShaders() {
  ...
  idVertexShader   = initVertexShader("flatShader.vert");
  idFragmentShader = initFragmentShader("flatShader.frag");
...
void initTexture(char *filename,int *w, int *h)
{
    ...
    *h = height;
    ...
    glGenerateTextureMipmap(idJpegTexture);
...
void initHeightMapTexture(char *filename,int *w, int *h)
{
    int width, height;
    ...
    glGenTextures(1,&idJpegHeightMapTexture);
    ...
    *h = height;
    ...
    glGenerateTextureMipmap(idJpegHeightMapTexture);
    /* wrap up decompression, destroy objects, free pointers and close open files */
    jpeg_finish_decompress( &cinfo );
    jpeg_destroy_decompress( &cinfo );
    free( row_pointer[0] );
