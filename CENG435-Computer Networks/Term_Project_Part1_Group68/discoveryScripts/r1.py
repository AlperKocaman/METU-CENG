...
clientSource = Thread(target = client, args = ('10.10.1.1', 20445,"Source")) # Source
clientSource.start()

clientR2 = Thread(target = client, args = ('10.10.8.2', 20446, "R2")) # R2
clientR2.start()

clientDestination = Thread(target = client, args = ('10.10.4.2', 20447, "Destination")) # Destination
