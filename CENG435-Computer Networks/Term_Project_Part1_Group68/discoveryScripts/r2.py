...
# create clients to send data and servers to receive data on different threads
serverR1 = Thread(target=server, args=(20446,)) # R1
serverR1.start()

serverR3 = Thread(target=server, args=(20451,)) # R3
serverR3.start()

clientSource = Thread(target = client, args = ('10.10.2.2', 20448, "Source")) # Source
clientSource.start()

clientSource = Thread(target = client, args = ('10.10.5.2', 20449, "Destination")) # Destination
clientSource.start()