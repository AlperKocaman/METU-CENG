...
if __name__ == "__main__":
	...
	''' Port numbers below are the same as with in the TP1 although it is not necessary'''

	'''Receiver Socket from Source'''
	# source listen address in router1
	sourceListenAddr = ('10.10.1.2', 20445)
	...
	# destination listen address in router1
	destListenAddr = ('10.10.4.1', 20447)
	...
	sourceSendAddr = ('10.10.1.1', 20446)

	'''Sending address to Destination'''
	destSendAddr = ('10.10.4.2', 20448)
